import { HousingType, Offer } from '../../types';
      ...
      <div className="place-card__info">
        ...
        <div className="place-card__rating rating">
          <div className="place-card__stars rating__stars">
            <span style={{ width: `${offer.rating.toString()}%` }}></span>
        ...
        <p className="place-card__type">{offer.housingType === HousingType.Apartament ? 'Apartament' : 'Room'}</p>
      </div>
    </article>
